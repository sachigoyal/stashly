...
export default function Features({ headless = false }: { headless?: boolean }) {
  return (
    <section id="features" className="w-full max-w-7xl mx-auto py-12 md:py-16">
      {!headless && (
        ...
        <h2 className="text-xl md:text-2xl lg:text-3xl font-bold font-heading">Powerful Features</h2>
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                <div className="bg-primary/10 p-2 rounded-md transition-all duration-150 group-hover/item:bg-radial group-hover/item:from-blue-400 group-hover/item:to-blue-800">
                  {feature.icon}
                </div>
