 ...
 console.error("Verification incomplete:", result);
  ...
  if(verifying){
      ...
      <CardContent className="pt-3">
        {verificationError && (<div className="bg-red-50 text-red-700 p-4 rounded-lg mb-4 flex items-center gap-2">
      ...
      <Card className="w-full max-w-md shadow-md border border-gray-100">
        ...
        <CardFooter className="flex justify-center">
             <p className="text-sm text-muted-foreground">
                ...
                <Link href="/sign-in" className=" text-black hover:underline">Sign in</Link>
                 </p>
        </CardFooter>
      </Card>
    </div>
